    ...
    public class ProtectCameraFromWallClip : MonoBehaviour {
        ...
        private void LateUpdate() {
            ...
            for (int i = 0; i < m_Hits.Length; i++) {
                ...
                // not a trigger, and not attached to a rigidbody tagged with the dontClipTag
            ...
            if (hitSomething) Debug.DrawRay(m_Ray.origin, -m_Pivot.forward * (targetDist + sphereCastRadius), Color.red);
