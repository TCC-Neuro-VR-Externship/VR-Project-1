...
namespace UnityStandardAssets.Cameras {
    ...
    public class AutoCam : PivotBasedCameraRig {
        ...
        // Default TurnSpeed = 1
        private float m_TurnSpeed = 2; // How fast the rig will turn to keep up with target's rotation
        private float m_RollSpeed = 0.2f;// How fast the rig will roll (around Z axis) to match target's roll.
        // Default FollowVelocity = false, on for plane, off for cars
        private bool m_FollowVelocity = true;// Whether the rig will rotate in the direction of the target's velocity.
